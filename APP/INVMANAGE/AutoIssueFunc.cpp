...
#define AUTO_INV_NUM			1000		/**< 自动连续开票指定的发票数后写内存日志 */
...
//			}
			...
			if (0 == nCurrentInvNo)
			{
				printf("nCurrentInvNo = %u\n", nCurrentInvNo);
				system("free /usr/app/ >> /usr/app/free.log");
			}
			nCurrentInvNo++;
			if (0 == nCurrentInvNo%AUTO_INV_NUM)
			{
				printf("nCurrentInvNo = %u\n", nCurrentInvNo);
				system("free /usr/app/ >> /usr/app/free.log");
			}
